...
_Generado automáticamente el 2026-09-16T12:41:51.513Z — no editar a mano, se sobreescribe en cada publicación._
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | RF-01 | Motor de generación de 10 equipos y jugadores | HU-01 | — | — | Hecho ✓ dev | dev-prueba | — | — |
| 2 | RF-02 | Simulador de fixture y resultados de la temporada | HU-01 | — | — | Hecho ✓ dev | dev-prueba | RF-01 | — |
| 3 | RF-01 | Dockerizar la aplicación (Dockerfile y docker-compose) | RO-01 | — | — | Hecho | dev-prueba | RF-01 | — |
| 4 | RF-01 | Cálculo y vista de tabla de posiciones con semáforo de colores | HU-02 | — | — | Hecho ✓ dev | dev-prueba | RF-02 | — |
| 5 | RF-01 | Listado de fixture y filtrado de resultados por equipo | HU-03 | — | — | Hecho ✓ dev | dev-prueba | RF-02 | — |
| 6 | RF-01 | Sección de estadísticas de máximos goleadores y asistidores | HU-05 | — | — | Hecho | dev-prueba | RF-02 | — |
| 7 | RNF-01 | Diseño UI responsive y estilos de la clasificación | HU-02 | — | — | Hecho ✓ dev | dev-prueba | RF-01 | — |
| 8 | RF-01 | Detalle de partido con cronología de goles y sustituciones | HU-04 | — | — | Hecho | dev-prueba | RF-01 | — |
