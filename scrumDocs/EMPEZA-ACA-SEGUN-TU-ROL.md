...
_Generado automáticamente el 2026-09-15T19:07:51.608Z -- no editar a mano, se sobreescribe en cada publicación._
...
`SCRUM_API_URL` es `http://10.24.192.28:3000`. Se generó sola a partir de la URL con la que tu
