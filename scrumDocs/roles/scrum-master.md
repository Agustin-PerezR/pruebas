...
_Generado automáticamente el 2026-09-15T19:07:43.963Z -- no editar a mano, se sobreescribe en cada publicación._
...
`assignee` · `status` · `deliveryId` · `integrantes` · `estimated` · `dependencies` · `start` · `end` · `progress`
