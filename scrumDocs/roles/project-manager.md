...
_Generado automáticamente el 2026-09-15T19:07:42.562Z -- no editar a mano, se sobreescribe en cada publicación._
...
`name` · `description` · `type` · `status` · `assignee` · `estimated` · `real` · `observations` · `dependencies` · `position` · `start` · `end` · `rescheduleFromEstimate` · `moduleId` · `progress` · `aiGenerated` · `deliveryId` · `integrantes` · `approvalStatus`
